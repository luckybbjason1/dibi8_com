...
description: "一套面向工程师的自主 AI 智能体道德规范——不是抽象口号，而是七条可落地的强制规则，每条都对应具体的工程控制：最小权限授权、全程可审计、人在回路的可逆性、有界自主、不可断裂的问责链、失效保护默认值、..."
...
AI 智能体道德规范（2026）：构建自主智能体的实用治理框架 represents an important step forward in AI-powered development. As the ecosystem matures, we expect to see even more powerful capabilities emerge.
