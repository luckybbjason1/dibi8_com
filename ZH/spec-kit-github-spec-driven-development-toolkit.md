...

{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://dibi8.com/zh/resources/spec-kit-github-spec-driven-development-toolkit"
  }
}
</script>
...
规格套件：GitHub represents an important step forward in AI-powered development. As the ecosystem matures, we expect to see even more powerful capabilities emerge.
