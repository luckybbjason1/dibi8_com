...
faqs:
  ...
  - q: '学习 Hello-Agents 需要什么编程语言和环境？'
    a: '代码主要使用 Python（约 72.5%）和 Jupyter notebooks。推荐配置为 Python 3.9+、一个 OpenAI API key 或 GitHub Models 访问权限，本地模型可选用 Ollama，RAG 章节的向量数据库可选用 Chroma 或 Weaviate。'
...
**Hello-Agents** 是由中国知名开源 AI 教育社区 **Datawhale** 打造的**系统性开源 AI 智能体教程**，在 GitHub 上已获得 **45,600+ Stars**，成为从"LLM 用户"进阶为"Agent 系统构建者"的权威起点。
...
Hello-Agents 是当今最全面、最易懂、社区支持最强的 AI 智能体开发学习资源。它兼具**大学课程的深度**、**训练营的实用性**、**开源项目的社区活力**，以及**免费文档的价格**。
...
Hello-Agents: Datawhale 开源 AI 智能体教程如何帮你从零构建生产级 Agent represents an important step forward in AI-powered development. As the ecosystem matures, we expect to see even more powerful capabilities emerge.
