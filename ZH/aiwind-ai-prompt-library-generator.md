...
description: "AiWind 是一个免费 AI 提示词库，收录 1000+ 针对 GPT-Image 2、Nanobanana、Stable Diffusion、Midjourney 等主流模型的专业提示词，覆盖写实..."
...
faqs: - q: 'AiWind 是免费使用的吗？'
  ...
  - q: 'AiWind 提示词库中有哪些艺术风格？'
    a: 'AiWind 将提示词按风格分类，包括写实肖像、赛博朋克、3D 渲染（皮克斯风格）、风景摄影、美食摄影、时尚大片、动漫、中国传统国风、超现实主义以及信息图表。提示词可以按风格、模型或关键词进行筛选。'
  - q: 'AiWind 为 Stable Diffusion 推荐的 CFG Scale 和步数设置是什么？'
    a: '文章推荐 CFG Scale 设置为 7-12，采样步数为 20-50，采样器使用 DPM++ 2M Karras，分辨率为 1024x1024 或更高。这些参数能在提示词遵循度与图像质量之间取得良好平衡。'
...
- [Pixelle-Video: AI Auto Short Video Generator](/zh/resources/ai-tools/pixelle-video-ai-short-video-generator/)
