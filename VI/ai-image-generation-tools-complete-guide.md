...
Theo [OpenAI](https://openai.com), mô hình DALL-E 3 đã được huấn luyện trên hàng tỷ cặp văn bản-hình ảnh, cho phép nó hiểu các khái niệm trừu tượng, phong cách nghệ thuật và mối quan hệ không gian phức tạp. Kết quả là khả năng tạo hình ảnh từ các mô tả chi tiết mà trước đây chỉ có thể thực hiện bằng tay.
...
Midjourney hoạt động thông qua Discord, yêu cầu ngườI dùng nhập prompt qua bot. Gói Basic có giá 10 USD/tháng vớI 3,3 giờ GPU, gói Standard 30 USD/tháng vớI 15 giờ GPU. Theo [Midjourney](https://midjourney.com), nền tảng này hiện có hơn 20 triệu ngườI dùng đăng ký.
...
NgườI dùng Creative Cloud có 25 credit Firefly miễn phí mỗi tháng. Gói Premium 4,99 USD/tháng cung cấp 100 credit. Theo [Adobe](https://adobe.com), Firefly đã tạo ra hơn 6 tỷ hình ảnh kể từ khi ra mắt.
...

{
  ...
  "@type": "Article",
  "headline": "Công Cụ Tạo Hình Ảnh AI: Hướng Dẫn Đầy Đủ Về Midjourney, DALL-E, Stable Diffusion",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://dibi8.com/vi/resources/ai-image-generation-tools-complete-guide"
  }
}
</script>