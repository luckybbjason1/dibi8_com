...
description: "# Nuwa-Skill: Distill Any Person Thinking Model into AI Agent Skill — 23,000 Stars — Guide 2026"
date: 2026-09-20
...
Unlike traditional roleplay prompts that produce superficial imitations, Nuwa-Skill extracts five distinct cognitive layers: | Layer | What It Captures | Example |
|
* * *
|
* * *
...
Each layer is analyzed independently: `````yaml
# Example SKILL.md structure generated by Nuwa
name: "Steve Jobs"
description: "# Nuwa-Skill: Distill Any Person Thinking Model into AI Agent Skill — 23,000 Stars — Guide 2026"
cognitive_layers: expression: tone: "direct, confident, sometimes abrasive"
...
Use the [vercel-labs/skills](https://github.com/vercel-labs/skills) universal CLI tool that supports 55+ runtimes: `````bash
...
For advanced users who want to customize the installation: `````bash
...
Runtime-specific skill directories: | Runtime | Installation Path |
|
* * *
|
* * *
...
You can create skills for any person by providing their name and optionally additional context: `````yaml
...
Jobs Model: "You're asking the wrong question. The real question is: what would happen if you removed ALL features except one?"
`````
...
Generated skills can be exported and shared: `````bash
# Export a skill
...
Nuwa-Skill is innovative but has important limitations: 1. **Public information only** — The distillation is limited to what the person has publicly expressed. Private thoughts and unspoken frameworks cannot be captured.
