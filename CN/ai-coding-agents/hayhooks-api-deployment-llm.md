...
description: "title: "Hayhooks: Deploy Haystack Pipelines as REST APIs with On"
date: 2026-09-20
...
@celery_app.task
def run_indexing_pipeline(documents: list): # Long-running indexing work
...
@asynccontextmanager
async def lifespan(app: Hayhooks): # Startup
...

{
  ...
  "@type": "Article",
  "headline": "Hayhooks: Deploy Haystack Pipelines as REST APIs with One Command — 2026 Production Setup Guide",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://dibi8.com/resources/hayhooks-api-deployment-llm"
  }
}
</script>
