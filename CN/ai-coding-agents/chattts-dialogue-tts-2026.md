...
The legacy split: - **Concatenative TTS** (festival, etc.) — mechanical, no prosody, dying
...
**Two licenses, two different obligations**: - **Code**: AGPL-3.0 — copyleft, derivative works must open-source under AGPL
...
ChatTTS 2026: 39.3k-Star Open-Source Dialogue TTS with Laughter, Pauses, and Token-Level Prosody Control represents an important step forward in AI-powered development. As the ecosystem matures, we expect to see even more powerful capabilities emerge.
...
- [2026-05-25-trending-ai-agents](chattts-dialogue-tts-2026)
- [2026-06-01-trending-ai-agents](chattts-dialogue-tts-2026)
- [2026-06-08-trending-ai-agents](chattts-dialogue-tts-2026)
