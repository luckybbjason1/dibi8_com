...
aliases: - /posts/arize-ai-observability-llm/-
---
{{</* resource-info */>}}
...
Phoenix uses a **span-based tracing model** aligned with OpenTelemetry. Every operation in your LLM pipeline becomes a span with attributes, events, and parent-child relationships. The architecture breaks down into three layers: ### Instrumentation Layer
...

{
  ...
  "@type": "Article",
  "headline": "Arize AI Phoenix: The Open-Source LLM Observability Tool Tracing 100% of Your RAG Pipeline — 2026 Guide",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://dibi8.com/resources/arize-ai-observability-llm"
  }
}
</script>
