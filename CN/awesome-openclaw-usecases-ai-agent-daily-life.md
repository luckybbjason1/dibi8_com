...
faqs:
  ...
  - q: 'What are some real-world OpenClaw use cases for productivity?'
    a: 'Productivity is the largest category with 18 use cases, including a personal CRM that auto-discovers contacts from email and calendar, multi-channel customer service unifying WhatsApp, Instagram and email, automated meeting notes that create tasks in Jira or Linear, a habit tracker with Telegram/SMS check-ins, and a Second Brain you text to remember things.'
  - q: 'Can OpenClaw agents edit videos or build games?'
...
| **Pre-Build Idea Validator** | Scan GitHub, HN, npm, PyPI before building — avoid crowded spaces |
...
Browse the [awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) repository and pick a use case that matches your needs.
